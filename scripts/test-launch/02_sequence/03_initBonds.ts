...
async function main() {
  ...
  await FraxBonds.initializeBondTerms(bcv, 33100, minimumPrice, maxPayout, 10000, maxDebt, initialDebt);
  ...
  await MimBonds.initializeBondTerms(bcv, 33100, minimumPrice, maxPayout, 10000, maxDebt, initialDebt);
