...
/**
 * @dev rebases occur before distributions, so if set the same block, first rebase will be zero.
 * set nextEpochBlock = firstEpochBlock - epochLength for first rebase to distribute.
 */
